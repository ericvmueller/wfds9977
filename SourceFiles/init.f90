...
IF (VEG_LEVEL_SET) THEN
  ...
  ALLOCATE(M%XLEAD_LS(0:IBP1,0:JBP1))  ; CALL ChkMemErr('INIT','XLEAD_LS',IZERO)  ; M%XLEAD_LS  = 0._EB
  ALLOCATE(M%XTRAIL_LS(0:IBP1,0:JBP1)) ; CALL ChkMemErr('INIT','XTRAIL_LS',IZERO) ; M%XTRAIL_LS = 0._EB
  ALLOCATE(M%E_REL_LS(0:IBP1,0:JBP1))  ; CALL ChkMemErr('INIT','E_REL_LS',IZERO)  ; M%E_REL_LS  = 0._EB
  ALLOCATE(M%E_AVAIL_LS(0:IBP1,0:JBP1)); CALL ChkMemErr('INIT','E_AVAIL_LS',IZERO); M%E_AVAIL_LS= -1._EB
