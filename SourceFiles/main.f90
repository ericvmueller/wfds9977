...
! Quasi-coupled Level Set 
INTEGER :: N_CFD_CYCLES=0
REAL(EB), ALLOCATABLE, DIMENSION(:) :: VEG_LSET_CFD_COMPUTE_TIME_CNTR
...
ALLOCATE(VEG_LSET_CFD_COMPUTE_TIME_CNTR(NMESHES),STAT=IZERO)
CALL ChkMemErr('MAIN','VEG_LSET_CFD_COMPUTE_TIME_CNTR',IZERO)
VEG_LSET_CFD_COMPUTE_TIME_CNTR = 0.0_EB
...
!      IF (USE_MPI) CALL EXCHANGE_HVAC_SOLUTION
   ...
   IF (THERMAL_ELEMENTS) THEN
      DO NM=1,NMESHES
         ...
         CALL THERMAL_ELEMENT_HEAT_RELEASE(T(NM),NM)
      ENDDO
   ENDIF
