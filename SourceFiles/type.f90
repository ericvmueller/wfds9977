...
TYPE SURFACE_TYPE
   ...
   ! .TRUE. when MISC THERMAL_ELEMENTS=.TRUE. and this SURF has both HRRPUA>0 and a PART_ID,
   ! i.e., it is a fixed-HRRPUA burner that releases its heat through thermal elements rather
   ! than through gas phase combustion. Set in READ_SURF (read.f90).
   LOGICAL ::  THERMAL_ELEMENT_BURNER=.FALSE.
